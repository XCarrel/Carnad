...
namespace AddressBook.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,PhoneNumber,Email,BlackList,Gender,CountryId")] Contacts contacts)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,PhoneNumber,Email,BlackList,Gender,CountryId")] Contacts contacts)
        {
            if (id != contacts.Id)
            {
                return NotFound();
